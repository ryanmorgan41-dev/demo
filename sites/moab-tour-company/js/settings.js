...
(function () {
  ...
  function footerInfo(data) {
    ...
    // Opt-in target first (any chrome: <div data-site-info>), R&H-style footer as fallback.
    var foot = doc.querySelector('[data-site-info]') || doc.querySelector('.footer-bottom');
    if (!foot) return;
    var bits = [];
